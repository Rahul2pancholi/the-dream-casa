...
const phases = [
  {
    ...
    timeline: "Stage 1",
    desc: "We start by listening to you — understanding your family's daily routine, space requirements, budget, and design taste before creating any plans.",
    deliverables: [
      "In-person discussion & home site visit",
      "Understanding your lifestyle & storage needs",
      "Setting your budget & target completion date",
    ],
    output: "Initial Design Brief",
  ...
  },
  {
    ...
    id: "define",
    title: "Define",
    subtitle: "Layouts & Clear Pricing",
    timeline: "Stage 2",
    desc: "We create smart floor layouts, select materials together, and give you a detailed itemized bill upfront. No hidden costs or surprises later.",
    deliverables: [
      "Practical 2D floor layout options",
      "Selection of materials, wood finishes & colors",
      "Fixed itemized cost estimate (BOQ upfront)",
    ],
  ...
  },
  {
    ...
    id: "visualise",
    title: "Visualise",
    subtitle: "Realistic 3D Renders",
    timeline: "Stage 3",
    desc: "See exactly how your home will look in 3D before any work starts on site — including lighting, furniture, colors, and kitchen design.",
    deliverables: [
      "Full 3D room views from every angle",
      "Electrical, lighting & ceiling plans",
      "Custom furniture & modular kitchen designs",
    ],
    output: "Approved 3D Designs",
  ...
  },
  {
    ...
    timeline: "Stage 4",
    desc: "Our dedicated project engineer handles everything on site — civil work, electrical, plumbing, woodwork, and painting with regular updates.",
    deliverables: [
      "Weekly photos & video updates on your phone",
      "Precision factory-made woodwork & fitting",
      "Strict quality checks at every step",
    ],
    output: "Completed Site Work",
  ...
  },
  {
    ...
    timeline: "Stage 5",
    desc: "We deep-clean your entire home, test all lights and fittings, fix minor details, and hand over the keys — ready for you to move in immediately.",
    deliverables: [
      "Deep cleaning & dusting of the full home",
      "Final walk-through inspection with you",
      "Key handover & warranty documents",
    ],

  ...
  return (
    <section className="relative bg-[#FAF7F2] py-20 sm:py-28 px-6 sm:px-10 lg:px-16 text-[#1C2630] border-y border-[#E8E2D8] overflow-hidden">
      <div className="mx-auto max-w-7xl">
        {/* Section Header */}
        <div className="flex max-w-3xl flex-col items-center gap-3 text-center mx-auto mb-16 sm:mb-20">
          {/* Top Flourish Label */}
          ...
          {/* Subtitle */}
          <p className="text-sm sm:text-base leading-relaxed text-[#6B7280] max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 items-stretch">
          ...
          <div className="lg:col-span-4 flex flex-col rounded-2xl border border-[#E5DFD5] bg-[#FAF7F2] p-2 shadow-sm divide-y divide-[#E5DFD5]">
            {phases.map(({ number, title, subtitle }, idx) => {
              ...
              return (
                <button
                  ...
                  className={`group relative flex items-center justify-between p-4 sm:p-5.5 text-left rounded-xl transition-all duration-300 ${
                    isActive
                ...
                >
                  <div className="flex items-center gap-4 sm:gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] font-semibold tracking-wider text-[#a46f47] uppercase mt-1">
                        {subtitle}
                      </p>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-8 flex flex-col justify-between rounded-2xl border border-[#E8E2D8] bg-white shadow-sm overflow-hidden min-h-[520px]">
            {/* Top Details Area */}
            <div className="relative p-6 sm:p-10 z-10 flex-1 flex flex-col justify-between">
              {/* Giant Background Watermark Number */}
              <span className="absolute right-8 top-4 font-serif text-8xl sm:text-9xl font-light text-[#a46f47]/15 select-none pointer-events-none">
                {activePhase.number}
              </span>
              ...
              <div>
                ...
                {/* Main Stage Header */}
                <h3 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-normal text-[#0F1A24] leading-tight mt-1.5">
                  {activePhase.mainHeader}
                </h3>

                {/* Short Gold Underline */}
                <div className="h-0.5 w-12 bg-[#a46f47] mt-3.5 mb-4" />

                {/* Description */}
                <p className="text-sm sm:text-base leading-relaxed text-[#4B5563] max-w-2xl">
                  {activePhase.desc}
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mt-8 pt-6 border-t border-[#E8E2D8] items-start">
                ...
                <div className="md:col-span-7">
                  <h4 className="text-xs font-semibold tracking-widest text-[#a46f47] uppercase mb-4">
                    WHAT WE DO
                  </h4>
                  <div className="flex flex-col gap-3.5">
                    {activePhase.deliverables.map(({ text, Icon }, i) => (
                      <div key={i} className="flex items-center gap-3.5 text-xs sm:text-sm text-[#374151] font-medium">
                        <div className="flex h-8.5 w-8.5 shrink-0 items-center justify-center rounded-lg border border-[#E8E2D8] bg-[#FAF7F2] text-[#a46f47]">
                ...
                <div className="md:col-span-5 border-t md:border-t-0 md:border-l border-[#E8E2D8] pt-4 md:pt-0 md:pl-6">
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      <p className="font-serif text-base sm:text-lg font-medium text-[#0F1A24] leading-snug">
                        {activePhase.output}
                      </p>
                    </div>
                  </div>
            ...
            <div className="relative w-full h-60 sm:h-80 overflow-hidden border-t border-[#E8E2D8]">
              <Image

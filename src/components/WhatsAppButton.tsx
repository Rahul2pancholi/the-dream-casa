...
export function WhatsAppButton() {
  const message = encodeURIComponent(
    "Hello The Dream Casa! I'm interested in interior design for my home. Can we discuss?"
  );
  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" fill="white" width="28" height="28" aria-hidden="true">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.109.546 4.09 1.503 5.819L.057 23.525a.5.5 0 0 0 .607.61l5.797-1.416A11.945 11.945 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.891 0-3.667-.518-5.184-1.42l-.371-.222-3.843.938.974-3.758-.243-.388A9.943 9.943 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z" />
      </svg>
    </a>
  );
}

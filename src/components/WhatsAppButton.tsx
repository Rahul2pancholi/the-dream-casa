...
export default function WhatsAppButton() {
  return (
    <a
      ...
      aria-label="Start a private consultation on WhatsApp"
      className="fixed bottom-6 right-6 z-50 flex h-11 w-11 items-center justify-center rounded-full bg-ink text-white shadow-md transition-all hover:bg-ink/90 hover:shadow-lg print:hidden"
    >
      <svg
        viewBox="0 0 32 32"
        fill="currentColor"

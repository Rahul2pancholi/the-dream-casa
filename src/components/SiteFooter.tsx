...
const services = [
  ...
  { label: "Modular Kitchens", href: "/modular-kitchen-designer-indore" },
  { label: "Commercial & Office", href: "/commercial-office-interior-designer-indore" },
  { label: "Turnkey Execution", href: "/process" },
];
